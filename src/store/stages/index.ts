const backgrounds = {
  forestDark:
    "https://github.com/Guilherme-07062002/fifth-hell-react/blob/main/src/pages/Scenario/components/Image/assets/imgs/ForestDark.png?raw=true",
  cave: "https://github.com/Guilherme-07062002/fifth-hell-react/blob/main/src/pages/Scenario/components/Image/assets/imgs/Cave.png?raw=true",
  hades:
    "https://github.com/Guilherme-07062002/fifth-hell-react/blob/main/src/pages/Scenario/components/Image/assets/imgs/Hades.png?raw=true",
};
const titles = {
  forestDark: "Dark Forest",
  campSite: "Campsite",
...
export const stagesData = [
  // Campsite / Dark Forest Stages----------------------------------------------
  {
    ...
    image: backgrounds.forestDark,
    continue: true,
  },
  {
    title: titles.forestDark,
    description:
